...
function MyButton({ text, disabled }: MyButtonProps) {
  return (
    <button disabled={disabled} className='rounded-sm bg-black px-2 py-1 font-bold text-white'>
      {text}
    </button>
  )
}
  ...
  return (
    <main className='flex min-h-screen flex-col items-center justify-between p-24'>
      ...
      <div className='z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex'>
        ...
        <MyButton disabled={true} text='test1'></MyButton>
